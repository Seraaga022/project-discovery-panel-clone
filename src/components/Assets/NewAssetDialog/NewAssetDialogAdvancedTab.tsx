            ...
            <Box flex={1.2}>
              <Stack spacing={1}>
                ...
                <Box>
                  ...
                  >
                    Passive Subdomain Discovery for any provided root domains
                    (for example: app.hooli.com, dev.hooli.com) using Chaos.
                    Support is not available for URL, IP, or CIDR.
                  </Typography>
                </Box>
              </Stack>
            </Box>
                      ...
                      title={
                        <Box maxWidth="200px" pr="20px">
                          ...
                          >
                            ...
                            domains by brute-forcing common subdomain names
                            using dnsx. Custom wordlist support coming soon.
                          </Typography>
                        </Box>
                      }
                      placement="right"
                      ...
                      title={
                        <Box maxWidth="200px" pr="20px">
                          ...
                          >
                            ...
                            discovered domains, subdomains, and IP addresses
                            using Naabu to identify open and accessible ports.
                          </Typography>
                        </Box>
                      }
                      placement="right"
